...
hmfuse.push({"user":"123@qq.com","pwd":"123456","phone":"12345678910"})
hmfuse.push({"user":"456@qq.com","pwd":"456789","phone":"12345678910"})
localStorage['login']=JSON.stringify(hmfuse);
...
function inputs(event){
    ...
    //判断用户名
    var regu=/(^[A-Za-z0-9]{6,16}$)|(^[\u4E00-\u9FA5]{2,8})$/;;
...
console.log("256"+flag)

console.log("256"+ flag2)
